...
def extract_restore_receipt(file_name):
...
imgfile_name = "E:/techela_21/Techela22/Bajaj_hackathon/Text_Extrctor/avi.jpg"
result = extract_restore_receipt(imgfile_name)
result.save("extract_01.png")
...
class HotelForm(forms.ModelForm):
    ...
    def save(self):       
        ...
        print(name)        
        hotel_Main_Img=self.cleaned_data.get('invoice_image')
        print(hotel_Main_Img)
        attendance = Hotel(name=self.cleaned_data.get('name'),invoice_image=self.cleaned_data.get('invoice_image'))
        attendance.save()
